...
('KING_AI_VS_BARB', 'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT', 'AI_KING_DIFFICULTY'),
('EMPEROR_AI_VS_BARB', 'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT', 'AI_EMPEROR_DIFFICULTY'),
('IMMORTAL_AI_VS_BARB', 'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT', 'AI_IMMORTAL_DIFFICULTY'),
('DEITY_AI_VS_BARB', 'MODIFIER_PLAYER_UNITS_ADJUST_BARBARIAN_COMBAT', 'AI_DEITY_DIFFICULTY');
