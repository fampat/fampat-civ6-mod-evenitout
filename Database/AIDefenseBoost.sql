...
('TRAIT_ACCELARATE_AI_WALLS_PRODUCTION_KING', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION', 'AI_KING_DIFFICULTY', 1),
('TRAIT_ACCELARATE_AI_WALLS_PRODUCTION_EMPEROR', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION', 'AI_EMPEROR_DIFFICULTY', 1),
('TRAIT_ACCELARATE_AI_WALLS_PRODUCTION_IMMORTAL', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION', 'AI_IMMORTAL_DIFFICULTY', 1),
('TRAIT_ACCELARATE_AI_WALLS_PRODUCTION_DEITY', 'MODIFIER_PLAYER_CITIES_ADJUST_BUILDING_PRODUCTION', 'AI_DEITY_DIFFICULTY', 1);
