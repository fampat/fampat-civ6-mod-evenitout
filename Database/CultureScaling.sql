...
('CULTURE_SCALING_CLASSICAL', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_CLASSICAL', 1),
('CULTURE_SCALING_MEDIEVAL', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_MEDIEVAL', 1),
('CULTURE_SCALING_RENAISSANCE', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_RENAISSANCE', 1),
('CULTURE_SCALING_INDUSTRIAL', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_INDUSTRIAL', 1),
('CULTURE_SCALING_MODERN', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_MODERN', 1),
('CULTURE_SCALING_ATOMIC', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_ATOMIC', 1),
('CULTURE_SCALING_INFO', 'MODIFIER_PLAYER_CITIES_ADJUST_CITY_YIELD_MODIFIER', 'CULTURE_HIGH_DIFFICULTY_AI_INFO', 1);
